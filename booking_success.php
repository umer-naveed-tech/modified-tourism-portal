...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .detail-row { display: flex; justify-content: space-between; padding: 8px 0; font-size: 13.5px; border-bottom: 1px solid rgba(255,255,255,0.04); }
...
<body>
    ...
    <div class="success-card">
        ...
        <div class="detail-box">
            ...
            <div class="detail-row"><span>Total Amount</span><span class="amt">SAR <?php echo number_format($amount); ?></span></div>
        </div>
