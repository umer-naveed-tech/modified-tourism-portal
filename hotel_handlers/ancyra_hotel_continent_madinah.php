<?php
// hotel_handlers/ancyra_hotel_continent_madinah.php
//
// Ancyra Hotel by Continent Madinah -- 4 Star
// Double/Triple/Quad, NO weekday/weekend split. Breakfast always included.

require_once __DIR__ . '/base_handler.php';

class AncyraHotelContinentMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = ANCYRA_HOTEL_ID;
