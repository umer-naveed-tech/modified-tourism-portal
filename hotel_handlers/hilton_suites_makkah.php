<?php
// hotel_handlers/hilton_suites_makkah.php
//
// Hilton Suites Makkah -- 5 Star
// Sirf EK room type: "Double Room". No extra bed. 8 supplement options.
// Meal Plan aur Lunch/Dinner sirf static text (koi selection nahi).
// "Extra Person Per Night" wala row rate-sheet mein tha lekin Umer ne
// specifically kaha isay add na karo -- skip kiya.

require_once __DIR__ . '/base_handler.php';

class HiltonSuitesMakkahHandler implements HotelHandlerInterface {

    private $hotel_id = HILTONSUITES_HOTEL_ID; // set via define() in handler_factory.php

    private $supplement_prices = [
        'standard_partial_hv'    => 120,
        'junior_suite_partial_hv'=> 300,
        'junior_suite_partial_kv'=> 655,
        'onebed_cv'              => 345,
        'onebed_partial_hv'      => 440,
        'twobed_city'            => 1170,
        'twobed_partial_hv'      => 1410,
        'threebed_partial_kv'    => 1850,
    ];
    private $supplement_labels = [
        'standard_partial_hv'    => 'Standard Room Partial H.V',
        'junior_suite_partial_hv'=> 'Junior Suite Partial H.V',
        'junior_suite_partial_kv'=> 'Junior Suite Partial K.V',
        'onebed_cv'              => 'One Bedroom Suite C.V',
        'onebed_partial_hv'      => 'One Bedroom Suite Partial H.V',
        'twobed_city'            => 'Two Bedroom Suite City',
        'twobed_partial_hv'      => 'Two Bedroom Suite Partial H.V',
        'threebed_partial_kv'    => 'Three Bedroom Suite Partial K.V',
    ];
    ...
    public function getBookingOptions($hotel_id) {
        return ['extra_bed_available' => false, 'supplements' => $this->supplement_prices, 'supplement_labels' => $this->supplement_labels];
    }
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div class="supplement-options" style="display:block;">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="supplement" id="hs_supp_none" value="" checked onchange="calculateTotal()">
                <label class="form-check-label" for="hs_supp_none">None</label>
            </div>
            <?php foreach ($this->supplement_labels as $code => $label): ?>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="supplement" id="hs_supp_<?php echo $code; ?>" value="<?php echo $code; ?>" onchange="calculateTotal()">
                <label class="form-check-label" for="hs_supp_<?php echo $code; ?>">
