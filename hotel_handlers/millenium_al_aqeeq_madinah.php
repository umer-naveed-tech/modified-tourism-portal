<?php
// hotel_handlers/millenium_al_aqeeq_madinah.php
//
// Millenium Al Aqeeq Ex. Al Aqeeq Madinah -- 5 Star
// Double/Triple/Quad, NO weekday/weekend split. Breakfast always included.

require_once __DIR__ . '/base_handler.php';

class MilleniumAlAqeeqMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = MILLENIUMAQEEQ_HOTEL_ID;
