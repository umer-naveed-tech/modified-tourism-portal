<?php
// hotel_handlers/sheraton_makkah.php
//
// Sheraton Hotel Makkah -- 5 Star
// 7 room categories: DBL, TPL, QUAD, Junior Suite (2PAX), 1/2/3 Bedroom
// Apartment. NO weekday/weekend split -- price is purely date-range
// based (rate sheet has ek hi price per period, no WD/WE columns).
// Extra Bed hai (70 SR rate-sheet + 25 hidden markup = 95 SR customer
// ko dikhta hai). Meal Plan aur Lunch/Dinner sirf static text.

require_once __DIR__ . '/base_handler.php';

class SheratonMakkahHandler implements HotelHandlerInterface {

    private $hotel_id = SHERATON_HOTEL_ID;
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div class="extra-bed-option" style="display:block;">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="sheraton_extra_bed" name="extra_bed" value="1" onchange="calculateTotal()">
                <label class="form-check-label" for="sheraton_extra_bed">
                    Add Extra Bed
