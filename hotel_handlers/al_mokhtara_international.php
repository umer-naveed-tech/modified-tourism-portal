<?php
// hotel_handlers/al_mokhtara_international.php
//
// Al Mokhtara International Hotel Madinah -- 3 Star
// Double/Triple/Quad/Quint, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class AlMokhtaraInternationalHandler implements HotelHandlerInterface {

    private $hotel_id = ALMOKHTARAINTL_HOTEL_ID;
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div style="margin-top:16px; background:rgba(16,185,129,0.04); padding:12px 16px; border-radius:8px; border:1px solid rgba(16,185,129,0.06); font-size:13px; color:#34d399;">
            🛏️ Meal Plan: Room Only (no meal included)
        </div>
        <?php
        return ob_get_clean();
    }
