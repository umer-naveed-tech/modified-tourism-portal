<?php
// hotel_handlers/al_mokhtara_al_garbi.php
//
// Al Mokhtara Al-Garbi Hotel Madinah -- 2 Star
// Double/Triple/Quad/Quint, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class AlMokhtaraAlGarbiHandler implements HotelHandlerInterface {

    private $hotel_id = ALMOKHTARAALGARBI_HOTEL_ID;
