<?php
// hotel_handlers/al_mokhtara_golden.php
//
// Al Mokhtara Golden Hotel Madinah -- 2 Star
// Double/Triple/Quad/Quint, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class AlMokhtaraGoldenHandler implements HotelHandlerInterface {

    private $hotel_id = ALMOKHTARAGOLDEN_HOTEL_ID;
