<?php
// hotel_handlers/grand_zowar_madinah.php
//
// Grand Zowar Hotel Madinah -- 2 Star
// Triple/Quad/Quint/Haxa (NO Double room). NO weekday/weekend split.
// ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class GrandZowarMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = GRANDZOWARMADINAH_HOTEL_ID;
