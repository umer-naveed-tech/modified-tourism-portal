<?php
// hotel_handlers/shaza_regency_plaza_madinah.php
//
// Shaza Regency Plaza Madinah -- 5 Star
...
class ShazaRegencyPlazaMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = SHAZAREGENCY_HOTEL_ID;
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div style="margin-top:16px; background:rgba(16,185,129,0.04); padding:12px 16px; border-radius:8px; border:1px solid rgba(16,185,129,0.06); font-size:13px; color:#34d399;">
            🛏️ Meal Plan: Room Only (no meal included)<br>🍳 Breakfast: SAR 40 | 🍽️ Lunch or Dinner: SAR 80
        </div>
        <?php
        return ob_get_clean();
    }
