<?php
// hotel_handlers/dar_al_eiman_al_haram_madinah.php
//
// Dar Al Eiman Al Haram Hotel Madinah -- 5 Star
// Double/Triple/Quad, NO weekday/weekend split. Breakfast always included.

require_once __DIR__ . '/base_handler.php';

class DarAlEimanAlHaramMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = DARALEIMANHARAM_HOTEL_ID;
