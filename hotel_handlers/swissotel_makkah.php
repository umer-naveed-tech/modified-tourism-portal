<?php
// hotel_handlers/swissotel_makkah.php
//
// Swissotel Makkah -- same structure as Fairmont Clock Tower:
// room_type_code = room category, room_type = bed config, is_weekend
// split, breakfast always included. No extra bed, no meal add-on.

require_once __DIR__ . '/base_handler.php';

class SwissotelMakkahHandler implements HotelHandlerInterface {

    private $hotel_id = SWISSOTEL_HOTEL_ID; // set via define() in handler_factory.php
