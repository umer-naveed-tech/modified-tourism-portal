<?php
// hotel_handlers/peninsula_worth_madinah.php
//
// Peninsula Worth Hotel Madinah -- 3 Star
// Double/Triple/Quad, NO weekday/weekend split. Bed & Breakfast basis.
// "Meal Board Supplements = 150 SR per pax per day" -- info text only.

require_once __DIR__ . '/base_handler.php';

class PeninsulaWorthMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = PENINSULAWORTH_HOTEL_ID;
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div style="margin-top:16px; background:rgba(16,185,129,0.04); padding:12px 16px; border-radius:8px; border:1px solid rgba(16,185,129,0.06); font-size:13px; color:#34d399;">
            🍳 Meal Plan: Bed &amp; Breakfast<br>ℹ️ Meal Board Supplement (Half/Full Board upgrade): SAR 150 per person per day -- ask our team if you'd like this added
        </div>
        <?php
        return ob_get_clean();
    }
