<?php
// hotel_handlers/al_mokhtara_diamond.php
//
// Al Mokhtara Diamond Hotel Madinah -- 3 Star
// Double/Triple/Quad/Quint, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class AlMokhtaraDiamondHandler implements HotelHandlerInterface {

    private $hotel_id = ALMOKHTARADIAMOND_HOTEL_ID;
