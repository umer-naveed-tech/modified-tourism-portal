<?php
// hotel_handlers/al_ritz_al_madinah.php
//
// Al Ritz Al Madinah Hotel -- 4 Star
// Double/Triple/Quad/Suite, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class AlRitzAlMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = ALRITZ_HOTEL_ID;
