<?php
// hotel_handlers/deyar_al_eiman.php
//
// Deyar Al Eiman Hotel -- 4 Star
// Double/Triple/Quad, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class DeyarAlEimanHandler implements HotelHandlerInterface {

    private $hotel_id = DEYARALEIMAN_HOTEL_ID;
