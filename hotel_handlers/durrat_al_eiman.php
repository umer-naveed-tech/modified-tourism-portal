<?php
// hotel_handlers/durrat_al_eiman.php
//
// Durrat Al Eiman Hotel -- 4 Star
// Double/Triple/Quad, NO weekday/weekend split. ROOM ONLY basis.

require_once __DIR__ . '/base_handler.php';

class DurratAlEimanHandler implements HotelHandlerInterface {

    private $hotel_id = DURRATALEIMAN_HOTEL_ID;
