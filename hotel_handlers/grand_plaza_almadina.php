<?php
// hotel_handlers/grand_plaza_almadina.php
//
// Grand Plaza Almadina -- 3 Star
// Double/Triple/Quad, NO weekday/weekend split. ROOM ONLY basis.
// Breakfast/Lunch/Dinner -- info text only.

require_once __DIR__ . '/base_handler.php';

class GrandPlazaAlmadinaHandler implements HotelHandlerInterface {

    private $hotel_id = GRANDPLAZAALMADINA_HOTEL_ID;
