<?php
// hotel_handlers/millenium_al_taibah_madinah.php
//
// Millenium Al Taibah Hotel Madinah -- 4 Star
// Double/Triple/Quad, single period only, NO weekday/weekend split. Breakfast always included.

require_once __DIR__ . '/base_handler.php';

class MilleniumAlTaibahMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = MILLENIUMTAIBAH_HOTEL_ID;
