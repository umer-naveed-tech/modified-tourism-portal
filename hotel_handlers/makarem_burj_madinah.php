<?php
// hotel_handlers/makarem_burj_madinah.php
//
// Makarem Burj Al Madinah -- 5 Star
// 6 room categories (Deluxe/Club Deluxe/One Bedroom Suite/Club One
// Bedroom Suite/2 Bedroom Suite/3 Bedroom Suite). NO weekday/weekend
// split. Extra Bed: flat 150 SR (rate sheet) + 25 SAR hidden markup =
// 175 SR shown, same every period. Breakfast always included (Bed &
// Breakfast basis).

require_once __DIR__ . '/base_handler.php';

class MakaremBurjMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = MAKAREMBURJ_HOTEL_ID;
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div class="extra-bed-option" style="display:block;">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="mburj_extra_bed" name="extra_bed" value="1" onchange="calculateTotal()">
                <label class="form-check-label" for="mburj_extra_bed">
                    Add Extra Bed
