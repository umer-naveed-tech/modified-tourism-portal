<?php
// hotel_handlers/m_hotel_al_dana.php
//
...
class MHotelAlDanaHandler implements HotelHandlerInterface {

    private $hotel_id = MHOTELALDANA_HOTEL_ID;
    ...
    public function renderRoomSelection($hotel_id, $rooms) {
        ...
        <div style="margin-top:16px; background:rgba(16,185,129,0.04); padding:12px 16px; border-radius:8px; border:1px solid rgba(16,185,129,0.06); font-size:13px; color:#34d399;">
            🍤 Meal Plan: Room Only (Breakfast: SAR 35/person/night, Half Board: SAR 60/person/night)
        </div>
        <?php
        return ob_get_clean();
    }
