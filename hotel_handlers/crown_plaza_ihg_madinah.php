<?php
// hotel_handlers/crown_plaza_ihg_madinah.php
//
// Crown Plaza by IHG Madinah -- 5 Star
// SGL/DBL + Triple, NO weekday/weekend split. Breakfast always included.

require_once __DIR__ . '/base_handler.php';

class CrownPlazaIhgMadinahHandler implements HotelHandlerInterface {

    private $hotel_id = CROWNPLAZA_HOTEL_ID;
